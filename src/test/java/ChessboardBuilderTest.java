...
//        }
//        assertEquals(Rook.class, board.getPiece(7, 0));
//        assertEquals(Rook.class, board.getPiece(0, 0));
//        assertEquals(Knight.class, board.getPiece(6, 0));
//        assertEquals(Knight.class, board.getPiece(1, 0));
//        assertEquals(Bishop.class, board.getPiece(5, 0));
//        assertEquals(Bishop.class, board.getPiece(2, 0));
//        assertEquals(Queen.class, board.getPiece(4, 0));
//        assertEquals(King.class, board.getPiece(new Coordinate(3, 0)));
//    }
//
//    @Disabled
