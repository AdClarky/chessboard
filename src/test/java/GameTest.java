...
class GameTest {
    ...
    void GameOneTest() throws IOException {
        Autoplay autoplay = new Autoplay(game, Path.of("src/test/resources/randomGame1.pgn"));
    ...
    void GameTwoTest() throws IOException {
        Autoplay autoplay = new Autoplay(game, Path.of("src/test/resources/randomGame2.pgn"));
        assertDoesNotThrow(() -> autoplay.play());
    }
    ...
    void checkmateTest() throws IOException {
        Autoplay autoplay = new Autoplay(game, Path.of("src/test/resources/checkmateGame.pgn"));
        assertDoesNotThrow(() -> autoplay.play());
    ...
    void stalemateTest() throws IOException {
        Autoplay autoplay = new Autoplay(game, Path.of("src/test/resources/stalemateGame.pgn"));
        assertDoesNotThrow(() -> autoplay.play());
    ...
    void repetitionTest() throws IOException {
        Autoplay autoplay = new Autoplay(game, Path.of("src/test/resources/repetitionGame.pgn"));
        assertDoesNotThrow(() -> autoplay.play());
        assertTrue(game.isDraw());
    }
    ...
    void draw50Move() throws IOException {
        Autoplay autoplay = new Autoplay(game, Path.of("src/test/resources/50move.pgn"));
        assertDoesNotThrow(() -> autoplay.play());
        assertTrue(game.isDraw());
    }
}
